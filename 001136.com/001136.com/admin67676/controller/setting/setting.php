...
class Setting extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['config_review_customer_groups'] = (array)$this->config->get('config_review_customer_groups');
		$data['config_review_min_orders'] = (int)$this->config->get('config_review_min_orders');
	...
	public function save(): void {
		...
		if (!isset($this->request->post['config_review_customer_groups'])) {
			$this->request->post['config_review_customer_groups'] = [];
		}
