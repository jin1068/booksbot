...
class ColumnLeft extends \Opencart\System\Engine\Controller {
	...
	public function index(): string {
		...
		if ($this->user->hasPermission('access', 'catalog/product_database')) {
			$catalog[] = [
				'name'     => '产品数据库管理',
		...
		if ($this->user->hasPermission('access', 'catalog/spec_import')) {
				$catalog[] = [
					'name'     => $this->language->get('text_spec_import'),
			...
			if ($this->user->hasPermission('access', 'catalog/duobao')) {
				$duobao_children[] = [
					'name'     => $this->language->get('text_duobao_manage'),
					'href'     => $this->url->link('catalog/duobao', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'catalog/duobao_history')) {
				$duobao_children[] = [
					'name'     => $this->language->get('text_duobao_history'),
					'href'     => $this->url->link('catalog/duobao_history', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'catalog/duobao_ticket')) {
				$duobao_children[] = [
					'name'     => $this->language->get('text_duobao_ticket'),
					'href'     => $this->url->link('catalog/duobao_ticket', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}
			...
			if ($duobao_children) {
				$catalog[] = [
					'name'     => $this->language->get('text_duobao'),
					'href'     => $duobao_children[0]['href'],
					'children' => $duobao_children
				];
			}
			...
			if ($this->user->hasPermission('access', 'finance/recharge')) {
				$finance[] = [
					'name'     => $this->language->get('text_recharge_list'),
					'href'     => $this->url->link('finance/recharge', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'finance/transaction')) {
				$finance[] = [
					'name'     => $this->language->get('text_transaction_list'),
					'href'     => $this->url->link('finance/transaction', 'user_token=' . $this->session->data['user_token']),
					'children' => []
				];
			}

			if ($this->user->hasPermission('access', 'catalog/usdt_wallet')) {
				$finance[] = [
					'name'     => $this->language->get('text_usdt_wallet'),
