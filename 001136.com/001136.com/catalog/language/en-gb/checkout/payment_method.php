...
$_['text_payment']           = 'This store currently supports USDT payments only. Please confirm the option below to continue.';
$_['text_payment_usdt_title'] = 'USDT Digital Currency';
$_['text_payment_usdt_description'] = 'Pay securely with USDT (TRC20 / ERC20). Instructions will be shown after you place the order.';
