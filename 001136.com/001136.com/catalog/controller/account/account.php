...
class Account extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		$data['text_my_duobao'] = $this->language->get('text_my_duobao');
		$data['text_duobao_records'] = $this->language->get('text_duobao_records');
		...
		$data['usdt_recharge'] = $this->url->link('account/usdt_recharge', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token']);
		...
		$data['duobao'] = $this->url->link('account/duobao', 'language=' . $this->config->get('config_language') . '&customer_token=' . $this->session->data['customer_token']);
