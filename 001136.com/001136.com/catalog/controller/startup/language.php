...
class Language extends \Opencart\System\Engine\Controller {
	...
	public function index(): void {
		...
		// If session has language var
		if (isset($this->session->data['language']) && isset(self::$languages[$this->session->data['language']])) {
			$language_info = self::$languages[$this->session->data['language']];
		}
